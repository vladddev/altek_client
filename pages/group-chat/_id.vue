...
export default {
    ...
    methods: {
        ...
        connect() {
            ...
            this.chatSocket = new WebSocket( this.$store.state.backendSocketUrl + '/ws/chat/' + this.$route.params.id + '/?access_token=' + accessToken)
    ...
    created() {
        ...
        axios({
            method: 'get',
            url: self.$store.state.backendUrl + '/backend/api/users/current/chats/' + self.$route.params.id + '/',
            params: {
