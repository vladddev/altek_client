<template>
  <v-container fluid v-if="loadData">
    <email-notification-dialog v-if="loadData.location_update_emails || loadData.status_update_emails"
      :open="emailNotifDialog" :on-close="() => emailNotifDialog=false" :load-data="loadData">
    ...
    <v-row>
        ...
        <v-row>
          ...
          <v-col cols="12">
            <div class="form-group">
              ...
              <v-text-field disabled label="Pieces" v-model="loadData.pieces" :value="loadData.pieces"
                ></v-text-field>
              <v-text-field disabled label="Total weight (Ibs)" v-model="loadData.weight" :value="loadData.weight"
                ></v-text-field>
            </div>
            <div class="form-group">
              <div class="font-weight-bold" style="margin-top: 20px">BOL</div>
              <v-text-field disabled placeholder="BOL value" v-model="loadData.BOL" :value="loadData.BOL"
                ></v-text-field>
            </div>
            <div class="form-group">
              <div class="font-weight-bold" style="margin-top: 20px">Address</div>
              <v-text-field disabled :value="loadData.pickUpAt" v-model="loadData.pickUpAt" >
              </v-text-field>
            </div>
            <div class="form-group">
              <div class="font-weight-bold" style="margin-top: 20px">Recieved by</div>
              <v-text-field disabled :value="loadData.recieved_by" v-model="loadData.recieved_by" >
              </v-text-field>
            </div>
            <div class="form-group">
            ...
            <!-- <v-text-field
              ...
              ></v-text-field> -->
            <!-- <v-text-field disabled label="Your name"></v-text-field>
          </div> -->
      ...
      <v-col cols="3">
        <group-chat v-if="loadData && loadData.load_chat" :chatId="loadData.load_chat" :showFooter="false"></group-chat>
      </v-col>
    ...
    <emailNotificationDialog :open="emailNotifDialog" :close-event="onClose" :loadData="loadData"></emailNotificationDialog>
  </v-container>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      onClose() {
        this.emailNotifDialog = false;
      },
      updateData(parametr) {

        let formData = new FormData()
        formData.append(parametr, this.loadData[parametr])
